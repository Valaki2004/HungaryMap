...
var serviceAccount = require("./magyarorszagmap-firebase-adminsdk-cgvek-923f1d584b.json");
...
const verifyToken = (req, res, next) => {
  ...
  .catch((error) => {
    console.log("Hiba a token ellenőrzésénél!");
...
app.post('/setCustomClaims', verifyToken, (req, res) => {
  ...
  admin.auth().setCustomUserClaims(uid, updatedClaims)
