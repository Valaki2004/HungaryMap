...
@Component({
  selector: 'app-halozsakok',
  standalone: false,
  
  templateUrl: './halozsakok.component.html',
  styleUrl: './halozsakok.component.css'
})
export class HalozsakokComponent {
  shopDatas: ShopData[] = [];
  bikeDatas:any
  ...
  loadShopData() {
    this.webservice.getBedDatas().subscribe((res) => {
